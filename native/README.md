...
artifacts\publish\OPS-Monitor-v3.4.4-framework-dependent.zip
artifacts\publish\win-x64-self-contained\
artifacts\publish\OPS-Monitor-v3.4.4-win-x64-self-contained.zip
```
...
`OPS-Monitor-v3.4.4-win-x64-self-contained.zip` portable package or run
