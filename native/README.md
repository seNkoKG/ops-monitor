...
artifacts\publish\OPS-Monitor-v3.4.8-framework-dependent.zip
artifacts\publish\win-x64-self-contained\
artifacts\publish\OPS-Monitor-v3.4.8-win-x64-self-contained.zip
```
...
`OPS-Monitor-v3.4.8-win-x64-self-contained.zip` portable package or run
